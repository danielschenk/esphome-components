...
from .. import CONF_PUMP_ID, PUMP_COMPONENT_SCHEMA, intex_sf90220rc1_ns

DEPENDENCIES = ['intex_sf90220rc1']

CONF_POWER_SWITCH = 'power_switch'

PowerSwitch = intex_sf90220rc1_ns.class_("PowerSwitch", switch.Switch, cg.Component)
